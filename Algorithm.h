...
public:
	...
	static std::shared_ptr<Population> evolvePopulation(std::shared_ptr<Population> population, Maze &maze);
private:
	...
	static std::shared_ptr<Individual> tournamentSelection(std::shared_ptr<Population> population, Maze &maze);
};
